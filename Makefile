...
ifneq (,$(USING_EMSCRIPTEN))
EMCC_FLAGS = -s USE_ZLIB=1 -s DISABLE_EXCEPTION_CATCHING=0 -s EXPORTED_FUNCTIONS="['_main']" -s EXTRA_EXPORTED_RUNTIME_METHODS="['FS', 'callMain']" -s ALLOW_MEMORY_GROWTH=1 --pre-js emcc/pre.js
