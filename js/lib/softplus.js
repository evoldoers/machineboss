...
const SOFTPLUS_LOG_INFINITY    = (SOFTPLUS_INTLOG_PRECISION * (double) SOFTPLUS_INTLOG_INFINITY);

var cache[SOFTPLUS_CACHE_ENTRIES];
...
function int_softplus_neg (x) const {
  if (x < 0)
...
function int_logsumexp (a, b) const {
  return (a > b
