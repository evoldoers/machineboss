/**
 * 1D Viterbi algorithm with traceback (CPU fallback).
 *
 ...
 */
export async function viterbi1D(machine, inputSeq, outputSeq) {
  ...
  // Traceback: for each (p, s), store source state and type
